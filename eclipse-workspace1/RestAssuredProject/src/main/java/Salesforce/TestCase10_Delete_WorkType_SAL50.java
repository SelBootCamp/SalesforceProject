...
public class TestCase10_Delete_WorkType_SAL50 {
	
	@Test
	public void deleteWorkTasks() throws InterruptedException {
		...
		String expSuccessMessage= "Work Type \"Salesforce Project\" was deleted. Undo";
		
		Assert.assertEquals(expSuccessMessage, successMessage);
